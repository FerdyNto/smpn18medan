...
@section('content')
    ...
    <form action="{{ route('komunitas_posts.store') }}" method="POST" enctype="multipart/form-data" class="col-11">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="isi_post" rows="3" name="isi_post">{{ old('isi_post') }}</textarea>
        </div>
