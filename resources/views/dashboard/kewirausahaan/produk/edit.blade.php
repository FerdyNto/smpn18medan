...
@section('content')
    <div class="d-flex justify-content-between my-3">
        <a class="btn btn-secondary" href="{{ route('produk.index') }}" role="button">Kembali</a>
    </div>
    <h2 class="my-5">Form Edit Data Produk</h2>

    <form action="{{ route('produk.update', ['slug' => $usaha->slug]) }}" method="POST" enctype="multipart/form-data"
        class="col-11">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="kategori" name="kategori" value="Produk" class="form-control" readonly>
        </div>
        <div class="mb-3">
        ...
        @if ($usaha->gambar)
            <div class="mb-3">
                <img src="{{ url('img/produk') . '/' . $usaha->gambar }}" alt="{{ $usaha->nama }}" style="max-width:200px">
            </div>
        @endif
        ...
        <div class="mb-3">
            <input type="submit" class="btn btn-primary" value="Edit Produk">
        </div>
    </form>
